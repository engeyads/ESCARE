...
namespace ESCARE
{
    public partial class store : Page
    {
        ...
        {
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString);
            SqlCommand cmd = new SqlCommand("spINSERT_dbo_Store", con);
                cmd.CommandType = CommandType.StoredProcedure;

                cmd.Parameters.AddWithValue("@ArName", txtSArName.Text);
                cmd.Parameters.AddWithValue("@EnName", txtSEnName.Text);
                cmd.Parameters.AddWithValue("@location", ddlLocation.SelectedValue);
                cmd.Parameters.AddWithValue("@desc", txtDesc.Text);
                cmd.Parameters.AddWithValue("@valid", 1);
                cmd.Parameters.AddWithValue("@r_By", getUserID());
                con.Open();
