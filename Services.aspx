<%@ Page Title="الخدمات" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Services.aspx.cs" Inherits="ESCARE.Services" %>
        ...
        <div id="wrapper">
            ...
            <div class="Grid">
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <asp:GridView ID="grdServices" runat="server" DataKeyNames="SID,KID,CLID" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" CssClass="GridView" AllowPaging="True" PagerSettings-PageButtonCount="5" PageSize="6" PageIndex="0">
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="الضريبة">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="VAT" DataField="VatApplyed" runat="server" Checked='<%# Eval("VatApplyed").Equals(1) %>' onclick="return false;" />
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        ...
                                        <asp:TextBox ID="VAT" DataField="VatApplyed" runat="server" Text='<%# Bind("VatApplyed") %>' TextMode="Number" MaxLength="1" />
                                    </EditItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="مفعلة">
                                    <ItemTemplate>
                                        <asp:CheckBox ID="Available" DataField="Av" runat="server" Checked='<%# Eval("Av").Equals(1) %>' onclick="return false;" />
                                    </ItemTemplate>
                                    <EditItemTemplate>
                                        <%--<asp:CheckBox ID="Available" DataField="Available" runat="server" Checked='<%# DataBinder.Eval(Container.DataItem,"Available").ToString() == "1" %>' Text=<%# DataBinder.Eval(Container.DataItem,"Available").ToString() == "1" ? "1" : "0" %> ></asp:CheckBox>--%>
                                        <asp:TextBox ID="Available" DataField="Av" runat="server" Text='<%# Bind("Av") %>' TextMode="Number" MaxLength="1" />
                                    </EditItemTemplate>
                                </asp:TemplateField>
                ...
                <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString='<%$ ConnectionStrings:DefaultConnection %>' SelectCommand="SELECT [SID], [SName], [SArName], [KID], [KArName], [Price], [VatApplyed], [ClID], [CArName], [Av] FROM [Service]" UpdateCommand="spUPDATE_Services" UpdateCommandType="StoredProcedure" DeleteCommand="spDELETE_Services" DeleteCommandType="StoredProcedure">
                    ...
                    <UpdateParameters>
                        ...
                        <asp:Parameter Name="Av" Type="String"></asp:Parameter>
                    </UpdateParameters>
                </asp:SqlDataSource>
            </div>
            <br />
